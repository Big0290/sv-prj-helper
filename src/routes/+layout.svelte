      ...
      <Container maxWidth="xl">
        <nav class="nav">
          ...
          <div class="nav-links desktop-only">
            {#each navItems as item}
              {@const isActive =
                ...
                ($page.url.pathname.startsWith('/docs/components') && item.href === '/docs/components')}
          ...
          <div class="nav-actions">
            <Button variant="ghost" size="sm" href="https://github.com/Big0290/sv-prj-helper" class="github-btn">
