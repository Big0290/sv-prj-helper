<script lang="ts">
  ...
  import { Stack, Heading, Text, Card } from "../../../lib/ui/index.js";
...
<svelte:head>
  ...
  <meta
    name="description"
    content="Interactive component playground with theme switching and responsive controls"
  />
</svelte:head>
    ...
    <div class="page-header">
      <Stack gap="6">
        <div class="header-content">
          <Heading as="h1" size="1">Interactive Playground</Heading>
          <Text size="lg" color="var(--text-secondary)">
            Experience components with live prop controls, theme switching, and
            responsive testing
          </Text>
        </div>
        ...
        <div class="features-grid">
          <Card class="feature-card">
            <Stack gap="3">
              ...
              <Text size="sm" color="var(--text-secondary)">
                Test components in light, dark, and system themes with smooth
                transitions
              </Text>
            </Stack>
          </Card>
          ...
          <Card class="feature-card">
            <Stack gap="3">
              ...
              <Text size="sm" color="var(--text-secondary)">
                Generated code updates automatically based on your prop
                selections
              </Text>
            </Stack>
          </Card>
