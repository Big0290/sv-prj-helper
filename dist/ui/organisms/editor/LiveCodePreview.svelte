...
<div class="live-code-preview {layout}" style="--min-height: {minHeight};">
  <div class="editor-section">
    <!-- Tab Bar -->
    <div class="tab-bar">
      <button class="tab {activeTab === 'html' ? 'active' : ''}" onclick={() => (activeTab = 'html')}> HTML </button>
      <button class="tab {activeTab === 'css' ? 'active' : ''}" onclick={() => (activeTab = 'css')}> CSS </button>
      <button class="tab {activeTab === 'js' ? 'active' : ''}" onclick={() => (activeTab = 'js')}> JavaScript </button>

      <div class="tab-actions">
        {#if !autoRun}
          <Button size="sm" onclick={runCode}>Run</Button>
        {/if}
        <button class="toggle-preview" onclick={() => (showPreview = !showPreview)} aria-label="Toggle preview">
    ...
    <div class="editors">
      {#if activeTab === 'html'}
        <CodeEditor bind:value={html} language="html" theme="dark" lineNumbers={true} {minHeight} maxHeight="none" />
      {:else if activeTab === 'css'}
        <CodeEditor bind:value={css} language="css" theme="dark" lineNumbers={true} {minHeight} maxHeight="none" />
      {:else}
        <CodeEditor
          bind:value={js}
          language="javascript"
  ...
  {#if showPreview}
    <div class="preview-section">
      ...
      <iframe
        ...
        onload={() => {
          console.log('LiveCodePreview: iframe loaded, initializing preview...')
          updatePreview()
        }}
      ></iframe>
