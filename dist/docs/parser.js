 ...
 */
export function parsePropsFromInterface(interfaceContent) {
    const props = [];
 ...
 */
export function parseEventsFromInterface(interfaceContent) {
    const events = [];
 ...
 */
export function parseSlotsFromInterface(interfaceContent) {
    const slots = [];
 ...
 */
export function parseAccessibilityInfo(componentContent) {
    const accessibility = {};
 ...
 */
export function generateBasicExamples(componentName, props) {
    const examples = [];
    // Basic usage example
    examples.push({
        title: 'Basic Usage',
 ...
 */
export function createComponentDocumentation(name, category, importPath, typeContent, componentContent, description) {
...
// Helper functions
function extractDefaultValue(type) {
...
function extractEventDetail(type) {
