 ...
 */
export function generateComponentReadme(doc) {
    const sections = [
        generateHeader(doc),
...
function generateInstallation(doc) {
    return `## Installation
...
function generateAccessibility(accessibility) {
    const sections = [];
...
function generateRelatedComponents(relatedComponents) {
 ...
 */
export function validateDocumentation(content, template) {
    const errors = [];
